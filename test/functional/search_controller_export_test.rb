...
class SearchControllerExportTest < ActionController::TestCase
  ...
  test "should get export - marc" do
    ...
    get :export, { :id => '00972c5123877961056b21aea4177d0dc69c7318', :format => 'marc' }
  ...
  test "should get export - json" do
    stub_solr_response :precise_one_doc
    get :export, { :id => '00972c5123877961056b21aea4177d0dc69c7318', :format => 'json' }
    assert_response :success
  ...
  test "should get export - marcxml" do
    stub_solr_response :precise_one_doc
    get :export, { :id => '00972c5123877961056b21aea4177d0dc69c7318', :format => 'marcxml' }
    assert_response :success
  ...
  test "should get export - bibtex" do
    stub_solr_response :precise_one_doc
    get :export, { :id => '00972c5123877961056b21aea4177d0dc69c7318', :format => 'bibtex' }
    assert_response :success
  ...
  test "should get export - endnote" do
    stub_solr_response :precise_one_doc
    get :export, { :id => '00972c5123877961056b21aea4177d0dc69c7318', :format => 'endnote' }
    assert_response :success
  ...
  test "should get export - ris" do
    stub_solr_response :precise_one_doc
    get :export, { :id => '00972c5123877961056b21aea4177d0dc69c7318', :format => 'ris' }
    assert_response :success
  ...
  test "should get export - mods" do
    stub_solr_response :precise_one_doc
    get :export, { :id => '00972c5123877961056b21aea4177d0dc69c7318', :format => 'mods' }
    assert_response :success
  ...
  test "should get export - rdf" do
    stub_solr_response :precise_one_doc
    get :export, { :id => '00972c5123877961056b21aea4177d0dc69c7318', :format => 'rdf' }
    assert_response :success
  ...
  test "should get export - n3" do
    stub_solr_response :precise_one_doc
    get :export, { :id => '00972c5123877961056b21aea4177d0dc69c7318', :format => 'n3' }
    assert_response :success
  ...
  test "should fail to export on an invalid format" do
    stub_solr_response :precise_one_doc
    get :export, { :id => '00972c5123877961056b21aea4177d0dc69c7318', :format => 'html' }
    assert_response 406
  end
end
